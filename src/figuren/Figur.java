...
public abstract class Figur implements Cloneable {
	 ...
	 */
	public FlyweightFactory.Sprites getBild() {
		
		if(farbe.toString().toLowerCase().equals("weiss")) {
			if(getClass().getSimpleName().equals("Bauer")) {
				return Sprites.WEISS_BAUER;
			}
			if(getClass().getSimpleName().equals("Dame")) {
				return Sprites.WEISS_DAME;
			}
			if(getClass().getSimpleName().equals("Koenig")) {
				return Sprites.WEISS_KOENIG;
			}
			if(getClass().getSimpleName().equals("Laeufer")) {
				return Sprites.WEISS_LAEUFER;
			}
			if(getClass().getSimpleName().equals("Springer")) {
				return Sprites.WEISS_SPRINGER;
			}
			else {
				System.out.println("1");
				return Sprites.WEISS_TURM;
			}
		}else {
			if(getClass().getSimpleName().equals("Bauer")) {
				return Sprites.SCHWARZ_BAUER;
			}
			if(getClass().getSimpleName().equals("Dame")) {
				return Sprites.SCHWARZ_DAME;
			}
			if(getClass().getSimpleName().equals("Koenig")) {
				return Sprites.SCHWARZ_KOENIG;
			}
			if(getClass().getSimpleName().equals("Laeufer")) {
				return Sprites.SCHWARZ_LAEUFER;
			}
			if(getClass().getSimpleName().equals("Springer")) {
				return Sprites.SCHWARZ_SPRINGER;
			}
			else {
				return Sprites.SCHWARZ_TURM;
			}
		}
		/*if (bild == null) {
